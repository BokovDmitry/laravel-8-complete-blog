...
@section('content')
    ...
    <div class=" w-4/5 m-auto p-10">
        <div class="m-auto pt-4 pb-16 w-100 sm:m-auto flex flex-wrap gap-10">
            @if ($recentPosts->isEmpty())
                <p class="text-gray-600">No recent posts available.</p>
            @else
                @foreach ($recentPosts as $post)
                    <div class="flex flex-col justify-between items-center bg-gray-200 p-3 rounded-lg w-full md:w-100">  
                        <img 
